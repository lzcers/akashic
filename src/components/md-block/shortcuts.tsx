import { Point, Range, Transforms, Element as SlateElement, Editor } from "slate";
import { BulletedListElement, CustomElement } from "./custom-types";

export const SHORTCUTS: { [key: string]: CustomElement["type"] } = {
    "*": "list-item",
    "-": "list-item",
    "+": "list-item",
    ">": "block-quote",
